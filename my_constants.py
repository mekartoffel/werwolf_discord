...
ALREADY_SOMEWHERE = 'Du spielst doch schon woanders mit. Konzentriere dich doch lieber auf nur ein Spiel gleichzeitig.'
...
CUPID_INPUT = 'Wen möchtest du mit deinen Liebespfeilen abschießen? (__Schicke mir bitte die **Zahl** der Personen, die du abschießen möchtest.__) ' + INPUT_MORE
...
WILD_CHILD_INPUT = 'Wer soll dein Vorbild sein? (__Schicke mir bitte die **Zahl** der Person, die dein Vorbild sein soll.__)' + INPUT_ONE
...
HEALER_INPUT = 'Welche Person möchtest du beschützen? (__Schicke mir bitte die **Zahl** der Person, die du beschützen möchtest.__)' + INPUT_ONE + '(Du kannst auch dich selbst schützen.)'
...
SEER_INPUT = 'Wen möchtest du überprüfen? (__Schicke mir bitte die **Zahl** der Person, deren Identität du wissen möchtest.__)' + INPUT_ONE
...
WEREWOLVES_INPUT = ', wer soll gefressen werden? (__Schickt mir bitte die **Zahl** der Person, die gefressen werden soll.__)' + INPUT_ONE + 'Wenn jemand nicht wählen will oder kann, kann er auch `Enthaltung` eingeben.\nIhr könnt euch auch vorher absprechen.'
...
WHITE_WEREWOLF_INPUT = 'Wen möchtest du fressen? (__Schicke mir bitte die **Zahl** der Person, die du fressen möchtest.__)' + INPUT_ONE + '(Wenn du niemanden fressen möchtest, antworte mit `Niemanden`)'
...
WITCH_INPUT_KILL = 'Möchtest du noch jemanden mit deinem Gifttrank vergiften? (__Schicke mir bitte die **Zahl** der Person, die du töten möchtest.__)' + INPUT_ONE + '(Wenn du niemanden töten willst, antworte einfach mit `Nein`)'
...
ANGRY_MOB_COMMANDS = 'Eventuell nützliche Commands:\n ```?alive - Wer ist noch am Leben?\n?missing_vote - Wer hat noch nicht abgestimmt?\n?votes - Wer hat schon wie viele Stimmen?```'
