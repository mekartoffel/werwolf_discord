...
INPUT_ONE = 'Benutze dafür bitte den globalen oder Servernamen der Person.'
INPUT_MORE = 'Benutze dafür bitte den globalen oder Servernamen der Personen und trenne mit einem Komma.'
...
WEREWOLVES_INPUT = 'Wen möchtet ihr fressen? ' + INPUT_ONE
...
NOONE_WON = 'Alle sind gestorben. Es gibt keinen Gewinner, nur Verlierer. :('